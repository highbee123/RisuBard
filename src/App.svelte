...
<main class="flex bg-bgcolor w-full h-full max-w-100vw text-textcolor" ondragover={(e) => {
    ...
    try {
        if (name.endsWith('.risup')) {
            ...
            notifySuccess(language.fileDropImport.presetSuccess, {
            ...
            notifySuccess(language.fileDropImport.moduleSuccess, {
                description: file.name,
            })
            ...
            notifySuccess(language.fileDropImport.pluginSuccess, {
                description: file.name,
            })
        } else {
