...
export const languageEnglish = {
    ...
    "noPdfMessages": "There are no ordinary messages to package as PDF. Turn off PDF for this tool request.",
    "generating": "Generating PDF",
    "preparing": "Preparing PDF request",
    "waiting": "Waiting for response",
    "completed": "Completed",
    "statsRestart": "Restart the server to enable PDF statistics.",
    "statsLoadFailed": "Could not load PDF statistics. ({0})",
    "badgeInput": "Input {0}",
    "badgeSaved": "Estimated {0} tokens saved",
    "enable": "Use PDF (cannot be used with context caching)",
    "help": "Package conversation and prompts as PDF using the current model settings.",
    "ineligible": "Available when the Model ID contains gemini.",
    "settings": "PDF settings",
    "mode": "Packaging mode",
    "maximum": "Maximum — entire conversation in PDF",
    "balanced": "Balanced — keep system instructions",
    "font": "PDF font size (pt)",
    "merge": "Merge consecutive roles",
    "mergeHelp": "Only consecutive system and user messages are merged. Images and tool records remain separate.",
    "cacheHelp": "Context caching is bypassed while PDF is enabled.",
    "usage": "PDF usage",
    "openStats": "Detailed statistics",
    "priceSettings": "Pricing (optional)",
    "price": "Input price (USD / million tokens)",
    "priceHelp": "Supported gateways fetch prices automatically. A supplied price takes precedence. Token savings remain available without a price. Cost savings are estimates.",
    "unknownPrice": "Price unavailable",
    "statsTitle": "PDF usage and request history",
    "statsHelp": "View PDF usage and estimated savings by preset and model.",
    "empty": "No PDF requests yet.",
    "loading": "Loading PDF usage…",
    "refresh": "Refresh",
    "allPresets": "All PDF requests",
    ...
    "reset": "Reset PDF records",
    "exportConfirm": "All saved PDF request logs contain conversations and prompts. Export as JSON?",
    "resetConfirm": "Reset all PDF statistics and saved PDF request logs, regardless of the current filters? Non-PDF request records will be kept.",
    "comparisonHelp": "Before: PageFold's original character-based estimate. After: API usage. Requests with incomparable images or tools are excluded from savings.",
    "userRequests": "User requests",
    "requests": "API attempts",
    "successes": "Successful",
    "pages": "PDF pages",
    "saved": "Estimated net token savings",
    "savedUsd": "Estimated net cost savings",
    "rate": "Reduction",
    "input": "Input tokens",
    "output": "Output tokens",
    "reasoning": "Reasoning tokens",
    "comparable": "Comparable requests",
    "cacheHits": "PDF reuse",
    "inputKnown": "Known input usage",
    "outputKnown": "Known output usage",
    "failedInput": "Failed/aborted input tokens",
    "byModel": "By model",
    ...
    "time": "Time",
    "preset": "Preset",
    "inputFlow": "Input (estimate → API)",
    "duration": "Duration (seconds)",
    "status": "Status",
    "detail": "Details",
    "more": "Load earlier requests",
    "incomparable": "Not comparable",
    "aborted": "Aborted",
    "failed": "Failed",
    "detailTitle": "PDF request details",
    "requestBody": "Request body",
    "pdfBody": "PDF content",
    "responseBody": "Response body",
    "metadata": "Usage and settings",
    "missingBody": "Detailed logging is disabled or the record was removed."
},
    cbsEditor: {
    ...
    chatModuleActivation: {
        ...
        description: "All chats always applies to every chat for every character. Chat always applies to all existing and future chats for the current character. Either scope can enable a module.",
        selectDescription: "Find a module in its folder and select it.",
        globalHint: "Always enable in every chat for every character.",
        chatHint: "Always enable in all existing and future chats for the current character.",
        noChat: "Select a character to use this setting.",
    ...
    v2ImportTitle: "Import V2 items",
    v2ImportDesc: "Safely merge selected characters, modules, personas, prompts, and lorebooks from another RisuBard V2 data folder. The source stays read-only, and a failed import leaves the current data unchanged.",
    v2ImportSourcePath: "Source V2 data folder",
    v2ImportSourcePlaceholder: "Example: E:\\Risuwork\\RisuBard-workspace\\other-save",
    v2ImportPreview: "Check items",
    v2ImportChecking: "Checking folder...",
    v2ImportSelectAll: "Select all",
    v2ImportClearSelection: "Clear selection",
    v2ImportIncludeDependencies: "Include linked items",
    v2ImportDependencyHint: "Also imports modules, personas, and other items referenced by your selection.",
    v2ImportEmpty: "No importable items were found.",
    v2ImportAction: "Import selected items",
    v2ImportProgress: (percent: number) => `Importing... ${percent}%`,
    v2ImportConfirm: (count: number) => `Merge ${count.toLocaleString()} item(s) into the current data? Colliding IDs will be replaced and duplicate folder names will receive a number. The source folder will not be changed.`,
    v2ImportSuccess: (count: number) => `Imported ${count.toLocaleString()} item(s). Reloading the new data.`,
    v2ImportKinds: {
        character: "Character",
        module: "Module",
        persona: "Persona",
